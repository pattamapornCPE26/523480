...
def extract_snapshots_to_csv(file_path, output_file, label, attack_type):
    ...
    with open(output_file, 'w', newline='') as csvfile:
        ...
        # เขียนหัวข้อ
        writer.writerow([
            "PID", "RDDSK", "WRDSK", "WCANCL", "DSK", "CMD", "label", "type", "Timestamp"                               
        ])
        ...
        for snapshot in snapshots:
            ...
            for process in snapshot["processes"]:
                ...
                process_details = process.split(maxsplit=6)
...
# ใช้งานฟังก์ชัน
process_multiple_files("/home/os/Desktop/project/New_Files/host/attck/text_log/DISK", "/home/os/Desktop/project/New_Files/csv/attack/host/disk")